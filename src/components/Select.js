const Month = (props) => {
    ...
    return(
        <select name="month" class={`select-box ${cn}`} required="" aria-required="true" aria-invalid="false">
...
const Day = (props) => {
    ...
    return(
        <select name="day" class={`select-box ${cn}`} required="" aria-required="true" aria-invalid="false">
...
const Year = (props) => {
    ...
    return(
        <select name="year" class={`select-box ${cn}`} required="" aria-required="true" aria-invalid="false">
...
const Country = (props) => {
    ...
    return(
        <select name="country" class={`select-box ${cn}`} required="" aria-required="true" aria-invalid="false">
...
const State = (props) => {
    ...
    return(
        <select name="state" class={`select-box ${cn}`} required="" aria-required="true" aria-invalid="false">
            ...
            <option value="14">Lakshadweep</option>
            ...
            <option value="22">Pondicherry</option>
...
export {Month, Day, Year, Country, State}
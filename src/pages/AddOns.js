            ...
            <div className="addons-page">
                ...
                <div className="top-bar">
                    ...
                    <div className="circle-div second-circle">
                        ...
                        <span className="txt-span">ADD ONS</span>
                    </div>
                ...
                <h2 className="title-h2 mt-10 mb-5">Add Ons</h2>

                <p className="center mb-2"><a href="/review"  className='magenta'>Continue</a></p>
                ...
                <p className="center mt-4 mb-10"><a href="/review"  className='magenta'>Continue</a></p>
